...
if test -f "${BUILDCACHE}/build_hash_mfextaddon_soprano_${BRANCH}_`cat .build_hash`"; then
    echo "bypass=true" >> github_output
    echo "buildcache=null" >> github_outpu
    exit 0
fi
...
rm -f ${BUILDCACHE}/build_hash_mfextaddon_soprano_${BRANCH}_*
hash_file=${BUILDCACHE}/build_hash_mfextaddon_soprano_${BRANCH}_`cat .build_hash`
touch ${hash_file}
rm -f ./build_hash
